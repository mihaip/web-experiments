...
document.querySelector(".toggle-glass").onclick = function() {
    if (frameGlass.client.isEnabled()) {
        frameGlass.client.disable();
    } else {
        frameGlass.client.enable();
        frameGlass.client.addPopupNode(panelNode);
    }
};
